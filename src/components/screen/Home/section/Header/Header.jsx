...
import img1 from "../../../../../assets/img/Header/Background_2.jpg"
...
import HeaderBurger from "./Header_burger";
      ...
      <div className={styles.header_container}>
        <section className={styles.header_section}>
          ...
          <div className={styles.header_section__cols2}>
            ...
            <div className={styles.cols2_imgbox}>
              <div className={styles.cols2_imgbox_container}>
                <Title className="titleheader" text="Нет того, что нам не под силу — разработаем проект любой сложности" level={1}></Title>
                <Text  className="textheader" text="Доверяя свои проекты студии «Капитатор», вы можете быть спокойны за качество, бюджет и сроки выполнения. У нас работают специалисты со стажем более 15 лет. Мы тщательно согласовываем каждый этап с заказчиком и все рутинные процессы беременности у себя."></Text>
                <Image src={img1} className="imgheader"></Image>
              </div>
              <div className={styles.cols2_imgbox_container}>
                <Title className="titleheader" text="Нет того, что нам не под силу — разработаем проект любой сложности" level={1}></Title>
                <Text  className="textheader" text="Доверяя свои проекты студии «Капитатор», вы можете быть спокойны за качество, бюджет и сроки выполнения. У нас работают специалисты со стажем более 15 лет. Мы тщательно согласовываем каждый этап с заказчиком и все рутинные процессы беременности у себя."></Text>
